...
try {
    ...
    $mail->Username   = 'mariaierusalimskaa207@gmail.com'; // Логин на почте
    //Здесь использовать пароль от гугл защищеного приложения
    // Сам пароль от аккаунта 
    $mail->Password   = 'cgyyblduzbsdwwrq'; // Пароль на почте 
    $mail->SMTPSecure = 'ssl';
    $mail->Port       = 465;
    $mail->setFrom('mariaierusalimskaa207@gmail.com', 'Заявка с сайта'); // Адрес самой почты и имя отправителя

    // Получатель письма
    $mail->addAddress('drony061093@gmail.com');  
    $mail->addAddress('m.ierusalimskaya@gmail.com');
